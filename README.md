...
🛠️ **Proof of Concept:** [LegacyMigration](https://github.com/CanonTaito/LegacyMigration) — A portfolio project demonstrating the step-by-step migration of an ASP.NET WebForms application (.NET Framework 4.7.2) to ASP.NET Core Razor Pages, documenting modernisation patterns for legacy enterprise systems.
